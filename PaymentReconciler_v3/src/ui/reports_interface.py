...
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QFileDialog, QMessageBox, QDateEdit
)
from PySide6.QtCore import QDate

from qfluentwidgets import (
    PrimaryPushButton, SubtitleLabel, BodyLabel, ComboBox
)
...
class ReportsInterface(QWidget):
    ...
    def _init_ui(self):
        ...
        root.addWidget(SubtitleLabel("Reports"))
        root.addWidget(BodyLabel("Generate Excel reports from archived data."))

        row1 = QHBoxLayout()
        row1.addWidget(BodyLabel("Report Date:"))
        self.dt_report = QDateEdit(self)
        ...
        row1.addSpacing(16)
        row1.addWidget(BodyLabel("Counterparty:"))
        ...
        self.btn_export = PrimaryPushButton("Export Payment Breakdown to Excel…", self)
